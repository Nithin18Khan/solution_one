...
import 'package:solution_one/view_model/app_colors.dart';

@immutable
class AppStyle {
  TextStyle get body => text.body;
...
class _Text {
  ...
  final Map<String, TextStyle> _contentFonts = const {
    'en': TextStyle(fontFamily: 'Raleway', fontFeatures: [
...
// add, @immutable when design is solidified
class _Sizes {
